...
async def run_bot(transport: BaseTransport, runner_args: RunnerArguments) -> None:
    ...
    worker = PipelineWorker(
        ...
        observers=[
            # Forwards speaking/TTS/metrics events to the Pipecat Audio
            # Metrics app (https://github.com/daily-co/pipecat-mac-audio-metrics).
            # Fire-and-forget: harmless if the app is not running.
            AudioMetricsBridgeObserver(
                url=os.getenv("AUDIO_METRICS_WS_URL", "ws://localhost:8123")
            ),
        ],
    )
